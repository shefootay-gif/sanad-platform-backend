...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://127.0.0.1:3000", "https://sanad-platform-web.vercel.app", "https://sanad-platform-web-*-sherif-s-projects9.vercel.app", "https://sanad-platform-web.onrender.com"],
